...
import { ServiceScreenComponent,BankScreenComponent ,MoneyTransferScreenComponent,BankstatementComponent} from './index';
...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {path: 'transactions',component : BankScreenComponent},
